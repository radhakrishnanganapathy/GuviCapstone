...
secrets = toml.load("YoutubeHarversting/.streamlit/secrets.toml")
...
# DATABASE_URI =  "postgresql://radhakrishnan:weJyKwjSj60UNzr4MXIEZ79FV7sf2ZHY@dpg-coiuro5jm4es739v1hvg-a.oregon-postgres.render.com:5432/rkrish_db"
...
class Videos(Base):
     ...
     tags = Column(ARRAY(VARCHAR), nullable=True, index=True)
